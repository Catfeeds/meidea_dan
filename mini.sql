...
CREATE TABLE `lr_attr_spec_price_store` (
  ...
  `price_yh` decimal(9,2) DEFAULT NULL COMMENT '优惠价格',
...
CREATE TABLE `lr_shopping_char` (
  ...
  `pid` int(11) NOT NULL COMMENT '商品规格属性价格库存ID',
...
-- Records of lr_tag
-- ----------------------------
INSERT INTO `lr_tag` VALUES ('1', '测试标签1');
INSERT INTO `lr_tag` VALUES ('2', '我的标签');
...
-- Records of lr_user
-- ----------------------------
INSERT INTO `lr_user` VALUES ('3', 'LeeFon', 'LeeFon', '', '1501569828', '0', 'http://wx.qlogo.cn/mmhead/FFowRyeQrWia2HqZBUeR2ROdb1Wxb49QyTt2wAIDGEGI/132', null, '0', null, '1', '0', 'undefined', 'wx', '0', '0', '0.00', 'normal');
...
INSERT INTO `lr_web` VALUES ('5', '0', '服务条款', null, '0', null, '0');
INSERT INTO `lr_web` VALUES ('6', '0', '隐私政策', null, '0', null, '0');
